...
function projectCustomerSelf(customer360) {
  ...
  const safeActivity = internal.activity ? {
    ...
    last_booking_date: internal.activity.last_booking_date || null,
    last_booking_time: internal.activity.last_booking_time || null,
    last_booking_branch: internal.activity.last_booking_branch || null,
    last_booking_barber: internal.activity.last_booking_barber || null,
    last_booking_service: internal.activity.last_booking_service || null,
    last_booking_status: internal.activity.last_booking_status || null,
