...
--   failure_reason: bounded string (e.g. duplicate_suppressed, rate_limited, reddy_disabled, processing_failed, etc.)
--   terminal_source: bounded source caller (e.g. webhook_finally, outbound_guard, handoff_gate, etc.)
--   correlation_id: non-PII request correlation identifier
