...
class AIGroomingUI {
 ...
 this.showError(' Server belum siap. Pastikan backend running (node server/index.js)');
 ...
 ${e.imageUrl ? `<img src="${e.imageUrl}" alt="${e.name}" class="ai-photo-card-img" loading="lazy" />` : '<div class="ai-photo-card-placeholder"></div>'}
 ...
 ${block('3', '', 'Eyewear Recommendations', eyewearHTML)}
