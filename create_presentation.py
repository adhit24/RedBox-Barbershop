...
left_items = [
 ...
 ("", "Edit Booking", "Ubah layanan, tanggal, jam, kapster, atau catatan"),
...
add_text(slide, " Fitur Dashboard Admin", 0.65, 1.68, 5.7, 0.4,
...
crons = [
 ...
 (RGBColor(0x00, 0x70, 0xC0), " Expire Stale Bills\n(Moka GoShow)",
