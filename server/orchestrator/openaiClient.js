...
const INTENT_GUIDE = [
  ...
  'booking_availability_inquiry: generic availability question with no clear barber name or branch-wide shape; classify only',
  'barber_availability_query: named barber + date, asking which times are free (e.g. "Abdul hari ini kosong jam berapa?")',
  'specific_time_availability_query: named barber + a specific clock time, asking if that exact time is free',
  'branch_availability_query: branch-wide "who is free" with no barber named (e.g. "jam 7 malam Bypass siapa yang kosong?")',
