...
const REDBOX_KNOWLEDGE = freeze({
  ...
  branches: [
    { id: 'bypass', name: 'Redbox Bypass', aliases: ['bypass', 'redbox bypass', 'pusat'], address: 'Jl. Ahmad Yani No.88, Kecapi, Harjamukti, Cirebon, Jawa Barat', hours: { days: 'daily', opens: '10:00', closes: '21:00', timezone: 'Asia/Jakarta' }, contact_id: 'whatsapp-bypass', booking_url: 'booking.html?branch=bypass' },
    { id: 'samadikun', name: 'Redbox Samadikun', aliases: ['samadikun', 'redbox samadikun'], address: 'Jl. Kapten Samadikun No.60, Kesenden, Kec. Kejaksan, Kota Cirebon, Jawa Barat 45121', hours: { days: 'daily', opens: '10:00', closes: '21:00', timezone: 'Asia/Jakarta' }, contact_id: 'whatsapp-samadikun', booking_url: 'booking.html?branch=samadikun' },
    { id: 'csb', name: 'Redbox CSB Mall', aliases: ['csb', 'csb mall', 'cirebon super block'], address: 'CSB Mall, Jl. Dr. Cipto Mangunkusumo No.26, Kota Cirebon, Jawa Barat', hours: { days: 'daily', opens: '10:00', closes: '21:30', timezone: 'Asia/Jakarta' }, contact_id: 'whatsapp-csb', booking_url: 'booking.html?branch=csb' },
    { id: 'sumber', name: 'Redbox Sumber', aliases: ['sumber', 'redbox sumber'], address: 'Jl. Pangeran Cakrabuana No.2, Kemantren, Sumber, Kabupaten Cirebon, Jawa Barat 45611', hours: { days: 'daily', opens: '10:00', closes: '21:00', timezone: 'Asia/Jakarta' }, contact_id: 'whatsapp-sumber', booking_url: 'booking.html?branch=sumber' },
    { id: 'tegal', name: 'Redbox Tegal', aliases: ['tegal', 'tegal kota', 'redbox tegal'], address: 'Jl. Dr. Soetomo No.29, Pekauman, Kec. Tegal Barat, Kota Tegal, Jawa Tengah 52125', hours: { days: 'daily', opens: '10:00', closes: '21:00', timezone: 'Asia/Jakarta' }, contact_id: 'whatsapp-tegal', booking_url: 'booking.html?branch=tegal' },
  ],
  services,
