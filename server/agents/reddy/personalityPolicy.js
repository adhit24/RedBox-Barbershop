...
function buildReddyPersonalityPrompt(options = {}) {
  ...
  const safeNameLabel = firstName ? firstName : 'Kak';
  ...
  let prompt = '# PEDOMAN BEHAVIORAL & PERSONALITAS REDDY (v2.1 / Task 13.6.3)\n' +
    ...
    '     * Jika pesan pertama pelanggan adalah pertanyaan langsung (misal: "Haircut berapa?"), leburkan salam dan jawaban secara alami di awal: "Hai ' + safeNameLabel + ', Haircut di Redbox RpXX.XXX ya." (Diizinkan menyapa dengan nama saja, tanpa "Kak", tetapi DILARANG menggunakan ceremonial greeting seperti "Selamat datang di Redbox..." dan DILARANG menggunakan sapaan generik terpisah seperti "Ada yang bisa aku bantu?").\n' +
