...
- Akses data melalui dashboard admin

(Belum termasuk automation & advanced marketing)
...
- Dapat diakses oleh admin melalui dashboard
- Terorganisir secara otomatis berdasarkan aktivitas booking
...
3. Admin dapat melihat dan mengelola data melalui dashboard
...
- WhatsApp Automation (Reminder & Follow-up)
- Customer Segmentation (Loyal / Non-active)
- Promo & Broadcast System
