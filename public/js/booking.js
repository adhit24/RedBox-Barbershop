...
document.addEventListener('DOMContentLoaded', async () => {
 ...
 'haircut': { label: 'Hair', icon: '' },
 'shave': { label: 'Shave', icon: '' },
 'other': { label: 'Other Services', icon: '' },
 ...
 const catInfo = CATEGORY_LABELS[svc.category] || { label: svc.category, icon: '' };
 ...
 <div class="pro-pick-img"><div class="pro-pick-icon"></div></div>
