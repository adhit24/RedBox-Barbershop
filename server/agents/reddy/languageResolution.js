...
// Booking summaries generated by RedBox or pasted back by Indonesian customers
// often contain English-ish service names ("Gentleman Grooming", "barber",
// etc.). Those tokens must not flip an otherwise Indonesian structured message
// to English. A labeled Indonesian field is treated as an explicit local-language
// signal before generic foreign-language heuristics run.
const INDONESIAN_STRUCTURED_BOOKING_FIELD = /(?:^|\n)\s*(?:nama|layanan|harga|durasi|kapster|tanggal|hari|jam|cabang|lokasi|nomor\s*(?:wa|whatsapp|hp))\s*:/im;
